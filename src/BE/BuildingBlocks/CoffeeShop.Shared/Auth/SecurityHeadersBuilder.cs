   ...
   public class SecurityHeadersBuilder
    {
        ...
        public SecurityHeadersBuilder AddDefaultSecurePolicy()
        {
            ...
            AddReferrerPolicy();
            AddXPermittedCrossDomainPolicies();
            RemoveServerHeader();
        ...
        public SecurityHeadersBuilder AddXPermittedCrossDomainPolicies()
        {
            _policy.SetHeaders[XPermittedCrossDomainPoliciesContants.Header] = XPermittedCrossDomainPoliciesContants.None;
            return this;
        }
